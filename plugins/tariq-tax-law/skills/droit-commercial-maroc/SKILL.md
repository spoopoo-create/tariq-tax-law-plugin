...
Pour un dossier commercial (sociétés, contrats, difficultés), au-delà de la recherche / lecture :
...
- Chaque affirmation porte sa **source publique exacte** (article du Code de commerce ou de la loi sur les sociétés — version applicable —, arrêt n° Z…), point.
